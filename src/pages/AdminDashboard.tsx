...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const savedOrders = JSON.parse(
      localStorage.getItem("polytechnic-orders") || "[]"
    );
  ...
  const handleMarkCompleted = () => {
    ...
    const updatedOrders = orders.map((order) =>
      order.id === searchResult.id ? { ...order, status: "completed" } : order
    );
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-col md:flex-row md:space-x-2 space-y-2 md:space-y-0">
                  ...
                  <Button onClick={handleSearchOrder} className="md:mt-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            {searchResult.isSignedIn ? "Yes" : "No"}
                          </p>
                          <p>
                  ...
                  <Card className="border-red-200 bg-red-50">
                    <CardContent className="pt-4">
                      ...
                      <p className="text-red-700 text-sm mt-2">
                        This Order ID does not exist in our system. This may be
                        a fraudulent slip.
                      </p>
                    </CardContent>
                  </Card>
                ...
                <Card key={order.id}>
                  <CardContent className="pt-4">
                    ...
                    <p className="text-sm text-gray-600">
                      ...
                      {order.isSignedIn ? "Signed In" : "Guest"}
                    </p>
                  </CardContent>
                </Card>
              ))
