      ...
      <div className="relative container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 text-lg leading-relaxed mb-6 max-w-md">
              ...
              Serving students with quality products and exceptional service since day one.
            </p>
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-blue-400 rounded-xl flex items-center justify-center transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {['About Us', 'Contact', 'Help Center', 'Terms & Conditions', 'Privacy Policy'].map((link) => (
                <li key={link}>
                  <a href="#" className="text-gray-400 hover:text-white transition-colors hover:pl-2 duration-200 block">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="space-y-4 text-gray-400">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm">Polytechnic Campus, Main Building</span>
              </div>
              <div className="flex items-center space-x-3">
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          <p className="text-gray-400 text-sm">
            © 2024 Polytechnic Store. All rights reserved. Made with ❤️ for students.
          </p>
